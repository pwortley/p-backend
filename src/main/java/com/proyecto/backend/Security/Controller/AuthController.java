package com.proyecto.backend.Security.Controller;

import com.proyecto.backend.Dto.Mensaje;
...
public class AuthController {
    ...
    private static class RolService {
    ...
    private static class JwtDto {

        public JwtDto() {
        }

        private JwtDto(String jwt, String username, Collection<? extends GrantedAuthority> authorities) {
            throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
        }
    }

    private static class LoginUsuario {
